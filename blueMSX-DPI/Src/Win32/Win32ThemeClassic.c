...
static ThemePage* themeCreateTriple()
{
	ThemePage* theme = themePageCreate("triple",
		648 + 320,                 // Width
		558 + 16 + 240,              // Hidth
		4,                   // Emu pos x
		51,                  // Emu pos y
	...
	themePageAddImage(theme, activeImageCreate(0, 0, 1, archBitmapCreateFromId(IDB_CLASSIC_BGBIG), 1), THEME_TRIGGER_NONE, THEME_TRIGGER_NONE);

	themePageAddText(theme, activeTextCreate(538+320, 514+240, 256, archBitmapCreateFromId(IDB_CLASSIC_FONT2), 0, 256, 5, 0, 0, 0), THEME_TRIGGER_TEXT_VERSION, THEME_TRIGGER_NONE);
	themePageAddText(theme, activeTextCreate(606+320, 514+240, 256, archBitmapCreateFromId(IDB_CLASSIC_FONT2), 0, 256, 5, 0, 0, 0), THEME_TRIGGER_TEXT_BUILDNUMBER, THEME_TRIGGER_NONE);

	themePageAddImage(theme, activeImageCreate(439 + 320, 540 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_DISKA), 2), THEME_TRIGGER_IMG_DISKA, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(457 + 320, 540 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_DISKB), 2), THEME_TRIGGER_IMG_DISKB, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(475 + 320, 540 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_CAS), 2), THEME_TRIGGER_IMG_CAS, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(530 + 320, 542 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_CAPS), 2), THEME_TRIGGER_IMG_CAPS, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(571 + 320, 542 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_KANA), 2), THEME_TRIGGER_IMG_KANA, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(602 + 320, 542 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_FS), 2), THEME_TRIGGER_IMG_FS, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(633 + 320, 542 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_AS), 2), THEME_TRIGGER_IMG_AS, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(238 + 320, 538 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_FPS), 2), THEME_TRIGGER_IMG_NOT_STOPPED, THEME_TRIGGER_NONE);
	themePageAddImage(theme, activeImageCreate(342 + 320, 538 + 240, 2, archBitmapCreateFromId(IDB_CLASSIC_FREQ), 2), THEME_TRIGGER_IMG_NOT_STOPPED, THEME_TRIGGER_NONE);

	themePageAddText(theme, activeTextCreate(370 + 320, 539+240, 256, archBitmapCreateFromId(IDB_CLASSIC_FONT), 0, 256, 9, 0, 0, 0), THEME_TRIGGER_TEXT_SCREEN, THEME_TRIGGER_NONE);
	themePageAddText(theme, activeTextCreate(310 + 320, 539 + 240, 256, archBitmapCreateFromId(IDB_CLASSIC_FONT), 0, 256, 5, 0, 0, 1), THEME_TRIGGER_TEXT_FREQ, THEME_TRIGGER_NONE);
	themePageAddText(theme, activeTextCreate(225 + 320, 539 + 240, 256, archBitmapCreateFromId(IDB_CLASSIC_FONT), 0, 256, 2, 0, 0, 1), THEME_TRIGGER_TEXT_FPS, THEME_TRIGGER_NONE);
	themePageAddText(theme, activeTextCreate(268 + 320, 539 + 240, 256, archBitmapCreateFromId(IDB_CLASSIC_FONT), 0, 256, 5, 0, 0, 0), THEME_TRIGGER_TEXT_CPU, THEME_TRIGGER_NONE);
...
ThemeCollection* themeClassicCreate() 
{
	...
	themeCollection->triple			 = themeCreate("triple");
	...
	themeAddPage(themeCollection->triple,		   themeCreateTriple());
